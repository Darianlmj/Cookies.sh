...
const SettingUpKaliLinuxPage = () => {
    ...
    document.title = "Setting Up Kali";
    window.scrollTo(0,0);
    
    return (
        <Container style={{color: '#ffffff'}}>
            <h1>Setting Up Your Kali Linux Virtual Machine</h1>
            <p>
            ...
            <ol>
                ...
                <li>
                    ...
                    <code>passwd [USERNAME]</code>. <br></br>
                ...
                <li>
                    ...
                    user. Type in <br></br>
                    <code>sudo usermod -aG sudo [USERNAME]</code> <br></br>
                ...
                <li>
                    ...
                    <code>sudo echo "Hello World!"</code> <br></br>
            ...
            <h3>Resources</h3>
            <ol>
                <li><a style={{color: '#ffffff'}} href='https://www.kali.org/docs/virtualization/install-virtualbox-guest-vm/'>Installing Kali on VirtualBox</a></li>
                <li><a style={{color: '#ffffff'}} href='https://www.tecmint.com/add-users-in-linux/'>Adding Users in Linux</a></li>
                <li><a style={{color: '#ffffff'}} href='https://www.lifewire.com/how-to-change-your-user-password-in-linux-4694406'>Changing Passwords in Linux</a></li>
                <li><a style={{color: '#ffffff'}} href='https://itsfoss.com/add-sudo-user-ubuntu/'>Giving sudo privileges to user</a></li>
            </ol>
